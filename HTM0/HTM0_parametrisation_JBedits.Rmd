...
In this section you will run the model to equilbrium using the function project() and will be able to plot the model simulaution output.

First, let's go through an example we have made previously to provide some tips of what to look for once you run the model.

```{r}
# All defaults
include_graphics("../paper/tempSummaryAnnoted.png")
```
