...
getError <- function(vary,params=params,dat=cdat$Catch_8595_tonnes,data_type="catch", tol = 0.1,timetorun=1) {
...
vals<-optimx(par=vary,getError,params=params,timetorun=1,lower=c(rep(3,12)),upper= c(rep(20,12)), method = c("L-BFGS-B"),
...
saveRDS(vals2,"optimx_vals2.RDS")
