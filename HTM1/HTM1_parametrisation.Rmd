...
> The Von Bertalanffy growth function predicts the length of a fish as a function of its age. Both growth rate and maximum size can be extrapolated from this relationship.
...
> Each species has a slightly different regression relationship which uses 2 parameters (usually called "a" and "b") and is based on the following formula:
> $$ w = a × L^b $$
...
![Figure 2: Effect of density dependence on recruitment](../paper/Rmax.png)
